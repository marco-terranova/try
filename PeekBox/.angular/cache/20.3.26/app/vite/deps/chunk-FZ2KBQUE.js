  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-C2OGEGSE.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-CPGNFMG6.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-MFTWPUGA.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-AS3OTWLS.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-EHEQVKZU.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-FZ2KBQUE.js.map
